...
function Eye() {
  return (
    <div style={styles.container}>
      <svg style={[styles.eye.closed, styles.eye]} key="eye-closed" id="closed" data-name="closed" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 221">
        <title>Closed</title>
        <path fill="white"
      ...
      <svg style={[styles.eye.half, styles.eye]} key="eye-half" id="half" data-name="half" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 221">
        <title>Half</title>
        <path fill="white"
      ...
      <svg style={[styles.eye.open, styles.eye]} key="eye-open" id="open" data-name="open" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 221">
        <title>Open</title>
        <path fill="white"
